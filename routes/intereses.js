...
router.get("/:plazo&:monto&:interes", async (req, res) => {
	...
	tabla.push(["Credito Personalizado (Interes: " + req.params["interes"] + ")", ((cae).toFixed(2))+"%", (valor_cuota).toFixed(0), parseFloat(req.params["interes"]), (valor_cuota*parseInt(req.params["plazo"])).toFixed(0)]);
